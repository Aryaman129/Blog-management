...
export function Footer() {
  ...
  return (
    <footer className="mt-20 border-t border-border/40 bg-surface/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              A showcase of modern web development projects and insights. 
            ...
            <div className="flex space-x-2">
              {socialLinks.map(({ href, icon: Icon, label }) => (
                <Button
                  ...
                  size="icon"
                  asChild
                  className="hover:bg-surface-elevated hover:text-primary transition-colors"
                >
                  <a
                    href={href}
                    target="_blank"
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <Button 
                variant="outline" 
                size="sm" 
                className="mt-4 border-primary/20 hover:bg-primary hover:text-white transition-colors"
                asChild
              >
